...
(brand/UI release on `feat/shiftpilot-brand-ui`; 309 tests / 24 files green; live
...
- 309 tests / 24 files, fully offline, in-memory SQLite, no `globalThis` mocks; CI runs all
