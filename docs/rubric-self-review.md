...
(final Week-1 state on `main`; suite re-verified 2026-08-20 on commit `dcee8f9`:
341 tests / 27 files green; live
...
- 341 tests / 27 files, fully offline, in-memory SQLite, no `globalThis` mocks; CI runs all
