...
gh release create v1.0.0-week1 \
  ...
  --notes "Week-1 submission for the Innovation Hacks AI Internship 2026. Capture → AI extraction → human review → deterministic planning → handover. 320 tests, offline by default, live OpenRouter free-tier verification recorded in docs/eval/."
```
